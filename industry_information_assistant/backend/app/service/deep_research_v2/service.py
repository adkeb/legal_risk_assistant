...
from .state import get_final_report, get_quality_score, get_references, get_artifact_writes
...
class DeepResearchV2Service:
    ...
    def __init__(
        ...
        self.max_iterations = config.research.max_iterations if max_iterations is None else max_iterations
    ...
    async def research_sync(
        ...
        return {
            ...
            "facts": get_artifact_writes(state, "evidence_matrix").get("facts", []),
