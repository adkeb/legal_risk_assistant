...
class MemoryService:
    ...
    def __init__(self):
        ...
        self.base_url = os.getenv("LLM_BASE_URL") or os.getenv("DASHSCOPE_BASE_URL") or os.getenv("OPENAI_BASE_URL")
        self.model = os.getenv("MEMORY_MODEL") or os.getenv("LLM_MODEL") or os.getenv("DASHSCOPE_MODEL") or os.getenv("OPENAI_MODEL", "")
        client_kwargs = {"api_key": self.api_key or "EMPTY_API_KEY"}
        if self.base_url:
