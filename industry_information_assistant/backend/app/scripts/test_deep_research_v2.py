...
async def test_full_workflow():
    ...
    # 检查环境变量
    dashscope_key = os.getenv("LLM_API_KEY") or os.getenv("DASHSCOPE_API_KEY") or os.getenv("OPENAI_API_KEY")
    bocha_key = os.getenv("BOCHA_API_KEY")
    llm_model = os.getenv("LLM_MODEL") or os.getenv("DEFAULT_MODEL") or os.getenv("DASHSCOPE_MODEL") or os.getenv("OPENAI_MODEL")
...
async def test_individual_agents():
    ...
    dashscope_key = os.getenv("LLM_API_KEY") or os.getenv("DASHSCOPE_API_KEY") or os.getenv("OPENAI_API_KEY", "")
    bocha_key = os.getenv("BOCHA_API_KEY", "")
    llm_base_url = os.getenv("LLM_BASE_URL") or os.getenv("DASHSCOPE_BASE_URL") or os.getenv("OPENAI_BASE_URL", "")
    llm_model = os.getenv("LLM_MODEL") or os.getenv("DEFAULT_MODEL") or os.getenv("DASHSCOPE_MODEL") or os.getenv("OPENAI_MODEL", "")
    ...
    try:
        ...
        architect = ChiefArchitect(dashscope_key, llm_base_url, llm_model)
    ...
    try:
        ...
        scout = DeepScout(dashscope_key, llm_base_url, bocha_key, llm_model)
    ...
    try:
        ...
        wizard = CodeWizard(dashscope_key, llm_base_url, llm_model)
